  ...
  <div class="publishing-guide-wrap" :class="{'menu-hide': toggleStatus}">
    <div class="publishing-menu-list">
      <div class="custom-scroll-wrap">
        <h1 class="publishing-guide-title"><span class="logo-img"><span class="blind">KGM</span></span><br>PUBLISHING GUIDE</h1>
        <ul>
      ...
      <p class="link-publist">
        <router-link to="/publishing/publist">PUBLISHING LIST</router-link>
      </p>
      <p class="link-convention">
        <router-link to="/publishing/convention">PUBLISHING CONVENTION</router-link>
      </p>
    </div>
